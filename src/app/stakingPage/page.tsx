    ...
    return (
        <div className="flex flex-col h-screen bg-[#1a2633]">
            ...
            <div className="flex-1 flex flex-col overflow-hidden lg:flex-row lg:gap-6 lg:px-6 lg:pt-6 lg:max-w-[1400px] lg:mx-auto lg:w-full">
                ...
                {/* Left Sidebar - Desktop Only - Larger */}
                ...
                <div className="flex-1 overflow-y-auto pb-20 lg:pb-6 px-3 lg:px-0 lg:min-w-0">
                    {stakeInitialized ? (
                        /* Success State */
                        <div className="max-w-4xl mx-auto pt-2 lg:pt-8">
                            {/* Success Card */}
                            <div className="bg-[#1a2633] rounded-xl mb-6">
                                {/* Success Header */}
                                <div className="bg-gradient-to-r from-[#60991A]/20 to-[#60991A]/10 border-l-4 border-[#60991A] px-4 py-4 lg:px-8 lg:py-6">
                                    <div className="flex items-center gap-4">
                                        <div className="w-8 h-8 lg:w-12 lg:h-12 rounded-full bg-[#60991A] flex items-center justify-center">
                                            <Check size={20} className="text-black font-bold" />
                                        </div>
                                        <div>
                                            <h2 className="text-[#60991A] text-lg font-bold lg:text-2xl">Bet Placed!</h2>
                                            <p className="text-gray-300 text-xs lg:text-sm">Share with a friend to complete the stake</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-4 lg:p-8 space-y-3 lg:space-y-4">
                                    <div className="grid grid-cols-2 gap-3 lg:gap-4">
                                        <div className="bg-[#16202C] rounded-lg p-3 lg:p-4">
                                            <div className="text-gray-400 text-xs mb-1">Stake Amount</div>
                                            <div className="text-[#FED800] text-lg font-bold lg:text-2xl">
                                                {currentStakeData.ownerStakeAmount} KES
                                            </div>
                                        </div>
                                        <div className="bg-[#16202C] rounded-lg p-3 lg:p-4">
                                            <div className="text-gray-400 text-xs mb-1">Your Pick</div>
                                            <div className="text-white text-sm font-bold capitalize lg:text-xl">
                                    ...
                                    <div className="bg-[#16202C] rounded-lg p-3 lg:p-4">
                                        ...
                                        <div className="text-[#60991A] text-lg font-semibold lg:text-2xl">
                            ...
                            {/* Share Options */}
                            <div className="bg-[#1a2633] rounded-lg p-4 lg:p-6 mb-4 lg:mb-6">
                                <h3 className="text-white font-bold text-sm mb-3 lg:text-lg lg:mb-4 flex items-center gap-2">
                                    <Share2 size={16} className="text-[#FED800] lg:size={20}" />
                                    Share Your Bet
                                </h3>

                                {/* Toggle Buttons */}
                                <div className="flex gap-2 mb-4 lg:gap-3 lg:mb-6">
                                    <button
                                        onClick={() => setUseQrCode(true)}
                                        className={`flex-1 py-2 rounded-lg font-semibold text-xs transition-all flex items-center justify-center gap-1 lg:py-3 lg:text-sm lg:gap-2 ${
                                            useQrCode 
                                ...
                                {useQrCode ? (
                                    <div className="flex flex-col items-center">
                                        <div className="bg-white p-3 rounded-lg mb-3 lg:p-4 lg:mb-4">
                                            {reduxStoreInviteCode && (
                                                <GeneratedQrCode code={reduxStoreInviteCode} />
                                            )}
                                        </div>
                                        <p className="text-gray-400 text-xs text-center lg:text-sm">
                                            Let your friend scan this code to join the bet
                                        </p>
                                    </div>
                                ) : (
                                    <div>
                                        <p className="text-gray-400 text-xs mb-2 lg:text-sm lg:mb-3">Share this code:</p>
                                        <div className="flex items-center gap-2 bg-[#16202C] rounded-lg p-3 lg:p-4">
                                            <code className="flex-1 text-[#FED800] font-mono text-sm break-all lg:text-lg">
                                                {reduxStoreInviteCode || 'Loading...'}
                                            </code>
                                            <button
                                                onClick={handleStakeCodeCopyButtonClick}
                                                className="bg-[#FED800] hover:bg-[#ffd700] text-black p-2 rounded-lg transition-colors shrink-0 lg:p-3"
                                            >
                                                {copied ? <Check size={16} /> : <Copy size={16} />}
                                            </button>
                                        </div>
                                        {copied && (
                                            <p className="text-[#60991A] text-xs text-center mt-1 animate-pulse lg:mt-2">
                                                Copied!
                                            </p>
                                        )}
                                    </div>
                            ...
                            <div className="flex gap-2 lg:gap-3">
                                <button
                                    ...
                                    className="flex-1 bg-red-600 hover:bg-red-700 text-white font-bold py-3 rounded-lg transition-all active:scale-95 flex items-center justify-center gap-2 text-sm lg:py-4 lg:text-base"
                                >
                                    <X size={16} />
                                    Cancel
                                </button>
                                <button
                                    ...
                                    className="flex-1 bg-[#60991A] hover:bg-[#4d7a15] text-black font-bold py-3 rounded-lg transition-all active:scale-95 flex items-center justify-center gap-2 text-sm lg:py-4 lg:text-base"
                                >
                                    <Check size={16} />
                                    Confirm
                                </button>
                        ...
                        /* Betting State */
                        <div className=" mx-auto pt-2 lg:pt-8 lg:max-w-4xl">
                            {/* Page Title - Mobile */}
                            <div className="mb-4 lg:mb-8">
                                ...
                                <div className="hidden lg:flex items-center justify-between">
                                    ...
                                    <div className="relative flex">
                                        ...
                                        <button
                                        onClick={() => setIsPublicStake(true)}
                                        className={`relative z-10 px-8 py-3 rounded-full font-semibold text-base transition-colors duration-300 ${
                                            isPublicStake 
                                            ? 'text-black' 
                                            : 'text-gray-400'
                                        }`}
                            ...
                            <div className="bg-[#1a2633] rounded-lg p-4 mb-4 lg:p-8 lg:mb-6">
                                ...
                                <div className="grid grid-cols-3 gap-2 lg:gap-4">
                                    <button
                                        ...
                                        className={`py-3 rounded-lg font-bold text-xs transition-all lg:py-6 lg:text-lg ${
                                    ...
                                    >
                                        <div className="text-xs text-gray-400 mb-1 lg:text-sm lg:mb-2">Home</div>
                                        {truncateTeamName(currentStakeData.homeTeam, 8)}
                                    </button>

                                    <button
                                        onClick={handleDrawButtonClick}
                                        className={`py-3 rounded-lg font-bold text-sm transition-all lg:py-6 lg:text-2xl ${
                                            currentStakeData.ownerStakeplacement === "draw"
                                                ? 'bg-[#FED800] text-black scale-105'
                                                : 'bg-[#16202C] text-white hover:bg-[#23313D]'
                                        }`}
                                    >
                                        <div className="text-xs text-gray-400 mb-1 lg:text-sm lg:mb-2">Draw</div>
                                        X
                                    </button>
                                    ...
                                    >
                                        <div className="text-xs text-gray-400 mb-1 lg:text-sm lg:mb-2">Away</div>
                ...
                {/* Right Sidebar - Desktop Only - Larger */}
